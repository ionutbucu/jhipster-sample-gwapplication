...
@AnalyzeClasses(packagesOf = JhipsterSampleGatewayApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhipsterSampleGatewayApp.class), alwaysTrue())
